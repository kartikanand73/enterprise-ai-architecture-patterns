...
| 8 | **Execution Models Matter: Snowflake Cortex vs. Databricks Genie** | Enterprise AI platforms may solve the same business problem, but their execution models fundamentally influence orchestration, state management, retries, and MCP integration. This architectural observation explains why those differences matter when building enterprise AI systems across multiple governed platforms. | [Medium](https://medium.com/@kartikanand_11915/enterprise-ai-architecture-pattern-8-what-building-snowflake-cortex-and-databricks-genie-taught-d5ec06f51575) | [GitHub](https://github.com/kartikanand73/databricks-genie-mcp/tree/main) |
| 9 | **Conversational Enterprise Operations** | Enterprise AI should not replace enterprise platforms—it should make them conversational. This pattern demonstrates how Microsoft Teams, Azure AI Foundry, Model Context Protocol (MCP), Azure API Management, and GitHub Actions can expose existing enterprise capabilities through natural language while preserving approvals, governance, RBAC, and audit controls. | [Medium](https://medium.com/@kartikanand_11915/enterprise-ai-architecture-pattern-9-conversational-enterprise-operations-073bed47293b) | [GitHub](https://github.com/kartikanand73/github-deploy-mcp) |
| 10 | **Teaching an Agent to Explain a ServiceNow Ticket Instead of Just Fetching It** | Enterprise AI should do more than retrieve operational data—it should interpret and explain it while keeping enterprise controls deterministic. This pattern demonstrates how Microsoft Teams, Azure AI Foundry, Model Context Protocol (MCP), and ServiceNow can automate repetitive ticket interactions while preserving identity boundaries, authorization, governed actions, and the system of record. | [Medium](https://medium.com/@kartikanand_11915/enterprise-ai-architecture-pattern-10-teaching-an-agent-to-explain-a-servicenow-ticket-instead-of-1de781f7cf0e) | [GitHub](https://github.com/kartikanand73/ServiceNowStatusAgent) |
